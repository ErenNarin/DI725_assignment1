...
from models.model import GPT, GPTConfig, Block, LayerNorm
...
class BumbleBee(GPT):
    def __init__(self, config, num_classes=3):
        ...
        # This is the part that adapts the model to give 3 classes sentiment scores, replacing the final layer with a linear layer with 3 outputs
